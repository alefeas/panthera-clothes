const products = [
    ...
    { id:5, name:'Remera Oversize.', price: 2990, porcDesc:10, page:'Mujeres', category:'Remeras', img:'camperablanca.jpg', slider:'no', stock:5 },
    ...
    { id:13, name:'Jogger de Jean.', price: 9990, porcDesc:10, page:'Mujeres', category:'Joggers', img:'camperablanca.jpg', slider:'si', stock:5 },
    { id:14, name:'Jean Oversize.', price: 12990, porcDesc:10, page:'Mujeres', categoria:'Jeans', img:'camperablanca.jpg', slider:'si', stock:5 },
    { id:15, name:'Jean Elastizado.', price: 10990, porcDesc:10, page:'Mujeres', category:'Jeans', img:'camperablanca.jpg', slider:'si', stock:5 },
    { id:16, name:'Collar de Plata.', price: 2990, porcDesc:10, page:'Mujeres', category:'Accesorios', img:'camperablanca.jpg', slider:'si', stock:5 },
    { id:17, name:'Buzo Oversize.', price: 8990, porcDesc:10, page:'Mujeres', category:'Buzos', img:'camperablanca.jpg', slider:'si', stock:5 },
    { id:18, name:'Buzo Oversize.', price: 8990, porcDesc:10, page:'Mujeres', category:'Buzos', img:'camperablanca.jpg', slider:'si', sliderIndex:'si', stock:5 },
    {
        id:19,
    ...
    { id:39, name:'Sandalias.', price: 2990, porcDesc:10, page:'Calzado', category:'Sandalias', img:'zapatillas.jpg', slider:'si', stock:5 },
